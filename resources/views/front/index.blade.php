                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="{{ route('front.project', $project->slug) }}"><img width="80" src="{{ asset($project->image) }}" alt=""></a>
                                </div>
                                @include('front._time')
                            </div>
                            <div class="items-link f-right">
                                <a href="{{ route('front.project', $project->slug) }}">{{ $project->type ? $project->type : 'Full Time' ; }}</a>
